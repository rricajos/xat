...
<div class="p-6">
  ...
  <table class="w-full">
    <thead class="bg-gray-50">
      <tr>
        <th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">Inbox</th>
    ...
    <tbody class="divide-y divide-gray-100">
      {#each data.inboxes as row}
        <tr class="hover:bg-gray-50">
          <td class="px-4 py-3 text-sm font-medium text-gray-900">{row.inbox.name}</td>
          <td class="px-4 py-3">
