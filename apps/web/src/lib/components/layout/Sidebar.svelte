...
<aside class="flex h-full w-full flex-col border-r border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
  ...
  <div class="border-t border-gray-100 px-2 py-2 dark:border-gray-800">
    <nav class="space-y-0.5">
      ...
      <a href="/app/calendar" class="flex items-center gap-2.5 rounded-md px-2.5 py-1.5 text-[13px] transition-colors {isActive('/app/calendar') ? 'bg-blue-50 text-blue-600 font-medium dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800'}">
        <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
